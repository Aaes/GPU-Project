...
\subsubsection{NVidia visual profiler result}
...
%Grid size & 1 & 1803\\\hline
%Block size&128,1,1&128,1,1\\\hline
%Registers/thread&62&63\\\hline
%Shared Memory/Block&0 bytes&1859 kb\\\hline
%Global Load Efficiency&90,2\%&777.1\%\\\hline
%Global Store Efficiency&99,2\%&25\%\\\hline
%Branch Divergence Overhead&22.3\%& 22.1\%\\\hline
%Occupancy(Theoretical = 33.3\%)&10.5\%&33.1\%\\\hline
\end{tabular}
\end{center}
\caption{NVidia Profiler}
