...
Shared Memory/Block\footnote{The visual profiler wrote that OuterPar used 1859 bytes of shared memory. This is however wrong. The command line profiler showed the correct result. The result can be calculated as 119*h2*8, which in this case is 119*2*8 = 1904 bytes.}&0 bytes&1904 bytes\\\hline
