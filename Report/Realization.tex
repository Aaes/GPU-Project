...
TODO: Insert results from analyser, and comment on them
...
\subsection{Comparison and expected results}
TODO: Describe the fundamental differences between the two, and argue which one should be the fastest and maybe how much faster.
